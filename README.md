...
<head>
    ...
    <style>
        body {
            ...
            background: linear-gradient(135deg, #02041b, #190f2e);
            color: #f0f0f0;
            overflow-x: hidden;
            overflow-y: auto;
        }
        ...
        .heart-container {
            position: relative;
            display: inline-block; /* Allows positioning context for children */
        }
        .heart {
            font-size: 8rem;
            color: #ff4d6d;
        ...
        .click-me-text {
            ...
            pointer-events: none; /* Prevents text from blocking heart click */
            white-space: nowrap;
        }
        .heart-container:hover .click-me-text {
            opacity: 1;
        }
        @keyframes pulse {
            0%, 100% {
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            function updateCounters() {
                ...
                // --- 3. Calculate Countdown to Emerald Anniversary ---
